...
vector < vector < B_number > > table; //original table : each row is the group, columns: group elements
vector < vector < B_number > > p_group; //mid process table  : each row is the group, columns: group elements
vector < vector < B_number > > final_group; //final table  : each row is the group, columns: group elements
...
void print_final_group() { // all prime implicants
  cout << endl << "FINAL:\n-------------------------------------" << endl;
  int i, j;
